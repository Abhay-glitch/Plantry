      ...
      <div id="plant" class="plants">
          ...
          <div class="row">
            <div class="col-md-12 ">
              <div class="titlepage">
                ...
                <span>looking at its layout. The point of using Lorem Ipsumletters, as opposed to using</span>
              </div>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
              <div class="plants-box">
                <figure><img src="./Assets/images/plant2.jpg" alt="img" /></figure>
                <h3> Frooty Vibrant</h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page   when looking at its layout. The point of using Lorem Ipsumletters, as opposed to using</p>
              </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
              <div class="plants-box">
                <figure><img src="./Assets/images/plant3.jpg" alt="img" /></figure>
                <h3> Miniature Garden</h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page   when looking at its layout. The point of using Lorem Ipsumletters, as opposed to using</p>
              </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
